...
df = spark.table("workspace.bronze_de.erp_px_cat_g1v2")
...
df.write.mode("overwrite").option("overwriteSchema", "true").format("delta").saveAsTable("workspace.silver_de.erp_product_category")
...
# MAGIC %sql
# MAGIC SELECT * FROM workspace.silver_de.erp_product_category LIMIT 10
