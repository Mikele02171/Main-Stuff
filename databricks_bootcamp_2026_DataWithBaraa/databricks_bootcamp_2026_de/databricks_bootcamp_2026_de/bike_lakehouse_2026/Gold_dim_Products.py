...
SELECT
    ...
    pn.product_line,
    pn.start_date
FROM silver_de.crm_products pn
LEFT JOIN silver_de.erp_product_category pc
...
df.write.mode("overwrite").format("delta").saveAsTable("workspace.gold_de.dim_products")
...
# MAGIC %sql
# MAGIC SELECT * FROM workspace.gold_de.dim_products LIMIT 10