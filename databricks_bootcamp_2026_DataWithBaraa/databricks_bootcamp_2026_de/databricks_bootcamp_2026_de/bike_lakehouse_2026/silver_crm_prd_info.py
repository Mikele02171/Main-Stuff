...
df = spark.table("workspace.bronze_de.crm_prd_info")
...
df.write.mode("overwrite").format("delta").saveAsTable("workspace.silver_de.crm_products")
...
# MAGIC %sql
# MAGIC SELECT * FROM workspace.silver_de.crm_products LIMIT 10