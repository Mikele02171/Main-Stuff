...
df = spark.table("workspace.bronze_de.erp_cust_az12")
...
df.write.mode("overwrite").format("delta").saveAsTable("workspace.silver_de.erp_customers")
...
# MAGIC %sql
# MAGIC SELECT * FROM workspace.silver_de.erp_customers LIMIT 10