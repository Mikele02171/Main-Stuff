...
df = spark.table("workspace.bronze_de.erp_loc_a101")
...
df.write.mode("overwrite").format("delta").saveAsTable("workspace.silver_de.erp_customer_location")
...
# MAGIC %sql
# MAGIC SELECT * FROM workspace.silver_de.erp_customer_location LIMIT 10
# MAGIC      
