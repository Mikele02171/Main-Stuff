...
df = spark.table("workspace.bronze_de.crm_sales_details")
...
df.write.mode("overwrite").format("delta").saveAsTable("workspace.silver_de.crm_sales")
...
# MAGIC %sql
# MAGIC SELECT * FROM workspace.silver_de.crm_sales LIMIT 10